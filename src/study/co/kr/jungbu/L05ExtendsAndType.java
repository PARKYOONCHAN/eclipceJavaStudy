...
//상속받은 타입을 자식이라 하고 상속을 한 타입을 부모라한다.
//자식은 부모의 필드를 물려 받는다.
public class L05ExtendsAndType {
	...
	public static void main(String[] args) {
		...
		ObjectB b =(ObjectB)c; //ObjectB가 참조할 수 있는 필드만 접근가능
...
//		 String s_o=(String)o;// 객체와 상관없는 타입으로 캐스팅 형변환하면 오류(컴파일시 발견되지 않는 심각한 오류)가 발생 -> 실행도중 발생하면 어플이 멈춘다.
